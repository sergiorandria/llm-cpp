...
struct GPTQEntry { std::string name; Tensor q; Tensor scale; size_t group = 128; };
...
std::pair<Tensor, Tensor> awq_rescale_for_quant(const Tensor& weight, const Tensor& act_mag, float alpha = 0.5f);
